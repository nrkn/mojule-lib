...
(function(){function i(a){return void 0!==a.value?a.setter():a.getter()}function l(a){return 0.299*a.red+0.587*a.green+0.114*a.blue}function s(a){var c=a.red/255,d=a.green/255,a=a.blue/255,f=Math.max(c,d,a),e=Math.min(c,d,a),g,m=(f+e)/2,j=f-e;if(f===e)g=e=0;else{e=0.5<m?j/(2-f-e):j/(f+e);switch(f){case c:g=(d-a)/j+(d<a?6:0);break;case d:g=(a-c)/j+2;break;case a:g=(c-d)/j+4}g/=6}return{hue:360*g,saturation:100*e,lightness:100*m}}function t(a){"#"===a.substr(0,1)&&(a=a.substr(1));return 3===a.length?
{red:parseInt(a.substr(0,1)+a.substr(0,1),16),green:parseInt(a.substr(1,1)+a.substr(1,1),16),blue:parseInt(a.substr(2,1)+a.substr(2,1),16)}:{red:parseInt(a.substr(0,2),16),green:parseInt(a.substr(2,2),16),blue:parseInt(a.substr(4,2),16)}}function q(a){a=a.toString(16);return 2>a.length?"0"+a:a}function u(a,b){return{hue:c(a.hue*c([b.hue,b.h,1]).firstDefined()).wrap(360),saturation:c(a.saturation*c([b.saturation,b.s,1]).firstDefined()).clamp(0,100),lightness:c(a.lightness*c([b.lightness,b.l,1]).firstDefined()).clamp(0,
100),alpha:c(a.alpha*c([b.alpha,b.a,1]).firstDefined()).clamp(0,1)}}function v(a,b){return{hue:c(a.hue+c([b.hue,b.h,0]).firstDefined()).wrap(360),saturation:c(a.saturation+c([b.saturation,b.s,0]).firstDefined()).clamp(0,100),lightness:c(a.lightness+c([b.lightness,b.l,0]).firstDefined()).clamp(0,100),alpha:c(a.alpha+c([b.alpha,b.a,0]).firstDefined()).clamp(0,1)}}var c=mojule.Extensions;mojule.Color=function(){function a(){return{red:Math.round(d),green:Math.round(f),blue:Math.round(e),alpha:k,css:"rgba( "+
...
getter:function(){return k}})};this.rgb=this.rgba=function(b){return i({value:b,setter:function(){d=c(c([this.value.red,this.value.r,d,0]).firstDefined()).clamp(0,255);f=c(c([this.value.green,this.value.g,f,0]).firstDefined()).clamp(0,255);e=c(c([this.value.blue,this.value.b,e,0]).firstDefined()).clamp(0,255);k=c(c([this.value.alpha,this.value.a,k,1]).firstDefined()).clamp(0,1);var b=s(a());g=b.hue;m=b.saturation;j=b.lightness;return h},getter:a})};this.hsl=this.hsla=function(a){return i({value:a,
setter:function(){g=c(c([this.value.hue,this.value.h,g,360]).firstDefined()).wrap(360);m=c(c([this.value.saturation,this.value.s,m,0]).firstDefined()).clamp(0,100);j=c(c([this.value.lightness,this.value.l,j,0]).firstDefined()).clamp(0,100);k=c(c([this.value.alpha,this.value.a,k,1]).firstDefined()).clamp(0,1);var a=b(),p=a.hue/360,o=a.saturation/100,n=a.lightness/100,a=function(a,c,b){0>b&&(b+=1);1<b&&(b-=1);return b<1/6?a+6*(c-a)*b:0.5>b?c:b<2/3?a+6*(c-a)*(2/3-b):a},i=0.5>n?n*(1+o):n+o-n*o,l=2*n-
i;0===o?o=n=p=n:(o=a(l,i,p+1/3),n=a(l,i,p),p=a(l,i,p-1/3));d=255*o;f=255*n;e=255*p;return h},getter:b})};this.bytes=function(b){return i({value:b,setter:function(){if(b instanceof Array){d=c(c([this.value[0],d]).firstDefined()).clamp(0,255);f=c(c([this.value[1],f]).firstDefined()).clamp(0,255);e=c(c([this.value[2],e]).firstDefined()).clamp(0,255);void 0!==this.value[3]&&(k=parseFloat((this.value[3]/255).toFixed(2)));var r=s(a());g=r.hue;m=r.saturation;j=r.lightness}return h},getter:function(){return[d,
f,e,Math.round(255*k)]}})};this.toString=this.css=function(){return 1===parseFloat(k)?h.hex():a().css};this.hex=function(b){return i({value:b,setter:function(){return h.rgba(t(this.value))},getter:function(){var b=a(),c=q(Math.round(b.red)),d=q(Math.round(b.green)),b=q(Math.round(b.blue));return"#"+(c.charAt(0)===c.charAt(1)&&d.charAt(0)===d.charAt(1)&&b.charAt(0)===b.charAt(1)?c.charAt(0)+d.charAt(0)+b.charAt(0):c+d+b)}})};this.brightness=function(){return l(a())};this.brightnessDifference=function(a){var b=
h.rgba(),a=(new mojule.Color(a)).rgba();return Math.abs(l(b)-l(a))};this.colorDifference=function(a){var b=h.rgba(),c=(new mojule.Color(a)).rgba(),a=Math.max(b.red,c.red),d=Math.min(b.red,c.red),e=Math.max(b.green,c.green),f=Math.min(b.green,c.green),g=Math.max(b.blue,c.blue),b=Math.min(b.blue,c.blue);return a-d+(e-f)+(g-b)};this.hasEnoughContrast=function(a,b,c){c=void 0!==c?c:125;return h.colorDifference(a)>=(void 0!==b?b:500)&&h.brightnessDifference(a)>=c};this.multiplyHsla=function(a){return h.hsla(u(h.hsla(),
a))};this.sumHsla=function(a){return h.hsla(v(h.hsla(),a))};this.clone=function(){return new mojule.Color(h.hsla())};this.getContrastingTone=function(){var a=mojule.Color,b=h.rgba(),c={red:255,green:255,blue:255},d={red:0,green:0,blue:0},e=Math.abs(l(b)-l(c)),b=Math.abs(l(b)-l(d))-30;return new a(b>e?d:c)};this.equals=function(){var a=new mojule.Color(c(arguments).toValue());return c([this.red(),this.green(),this.blue(),this.alpha()]).elementsEqual([a.red(),a.green(),a.blue(),a.alpha()])};mojule.Color.mapper.map(h,
